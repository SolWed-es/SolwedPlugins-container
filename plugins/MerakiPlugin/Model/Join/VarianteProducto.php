...
namespace FacturaScripts\Plugins\MerakiPlugin\Model\Join;
...
class VarianteProducto extends JoinModel
{
    ...
    protected function getFields(): array
    {
        return [
            ...
            'tallaetiqueta' => 'variantes.tallaetiqueta',
            'coloretiqueta' => 'variantes.coloretiqueta'
        ];
    }
    // joseferran joinmodel
     /**
