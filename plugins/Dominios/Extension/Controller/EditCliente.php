 ...
 * Obtiene datos en tiempo real desde la API del proveedor de dominios.
 */
class EditCliente
{
    /**
    ...
    public function loadData(): Closure
    {
        return function ($viewName, $view) {
            ...
            try {
                ...
                $service = new \FacturaScripts\Plugins\Dominios\Lib\DomainApiService();
                ...
                $view->error_message = 'Error al cargar dominios: ' . $e->getMessage();
