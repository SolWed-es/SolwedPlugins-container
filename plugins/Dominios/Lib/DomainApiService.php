...
final class DomainApiService
{
    ...
    {
        $this->apiClient = DomainApiClient::get();
    }
        ...
        try {
            ...
            if ($retry) {
                ...
                try {
                    ...
                    Tools::log()->error('domain-fetch-contacts-retry-failed', [
                        '%code%' => $codcliente,
    ...
    public function getDomainAuthCode(string $domain): ?string
    {
        ...
        try {
            ...
            Tools::log()->error('domain-authcode-error', [
                '%domain%' => $domain,
                '%message%' => $e->getMessage(),
            ]);
            return null;
    ...
    public function getDomainHistory(string $domain, int $pageLength = 20): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-history-error', [
                '%domain%' => $domain,
                '%message%' => $e->getMessage(),
            ]);
            return [];
    ...
    public function performDnsTest(string $domain, string $type = 'A'): ?array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-dig-error', [
                '%domain%' => $domain,
                '%type%' => $type,
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function getAccountInfo(): ?array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-account-info-error', [
                '%message%' => $e->getMessage(),
            ]);
            return null;
        }
    ...
    public function updateDomainNameservers(string $domain, array $nameservers): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-update-ns-error', [
                '%domain%' => $domain,
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function renewDomain(string $domain, int $years = 1): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-renew-error', [
                '%domain%' => $domain,
                '%years%' => $years,
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function resendVerificationEmail(string $domain): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-resend-verification-error', [
                '%domain%' => $domain,
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function setAutoRenew(string $domain, bool $enable, string $codcliente = '', bool $isAdmin = false): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-autorenew-error', [
                '%domain%' => $domain,
    ...
    public function setTransferLock(string $domain, bool $enable): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-transfer-lock-error', [
                '%domain%' => $domain,
                '%enable%' => $enable ? 'true' : 'false',
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function checkDomainAvailability(string $domain): array
    {
        ...
        try {
            ...
            Tools::log()->error('domain-check-domain-error', [
                '%domain%' => $domain,
                '%message%' => $e->getMessage(),
            ]);
    ...
    public function purchaseDomain(string $domain, string $codcliente, int $years = 1, bool $isAdmin = false): array
    {
        ...
        try {
            ...
            Tools::log()->info('domain-domain-purchased', [
                '%domain%' => $domain,
            ...
            Tools::log()->error('domain-purchase-error', [
                '%domain%' => $domain,
                '%codcliente%' => $codcliente,
                '%message%' => $e->getMessage(),
            ]);
