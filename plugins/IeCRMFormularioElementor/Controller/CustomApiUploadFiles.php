...
namespace FacturaScripts\Plugins\IeCRMFormularioElementor\Controller;

use FacturaScripts\Core\Template\ApiController;
use FacturaScripts\Plugins\IeCRMFormularioElementor\Lib\UploadedFile;
use FacturaScripts\Dinamic\Model\AttachedFile;
use FacturaScripts\Plugins\IeCRMFormularioElementor\Lib\Response;
...
class CustomApiUploadFiles extends ApiController
{
    ...
    protected function runResource(): void
    {
        ...
        foreach ($files as $file) {
            ...
            $customFile = new \FacturaScripts\Plugins\IeCRMFormularioElementor\Lib\UploadedFile($file);
