...
namespace FacturaScripts\Plugins\IeCRMFormularioElementor;
...
class Init extends InitClass
{
    public function init(): void
    {
        ...
        Kernel::addRoute('/api/3/customUploadFiles', 'CustomApiUploadFiles', -1);
        ApiRoot::addCustomResource('customUploadFiles');
    }
